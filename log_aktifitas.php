        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <?php
                    include "koneksi.php";
                    $log_aktifitas = mysqli_query($koneksi,"SELECT * FROM log_aktifitas ORDER BY tanggal DESC");
                    ?>  
                    <table class="table bordered">
                        ...
                        <?php
                        while($res_log = mysqli_fetch_array($log_aktifitas)) {
                        ?>
                        <tr>
                            <td><?php echo $res_log["tanggal"]; ?></td>
                            <td><?php echo $res_log["status"]; ?></td>
                        </tr>
                        <?php
                };
                    ?>
