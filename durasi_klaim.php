            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <table class="table bordered">
                            <h5>Minimum Durasi Klaim</h5>
                            <tr>
                                <td width="50%">Tahun</td>
                                <td width="50%">Minimum Durasi</td>
                            </tr>

                            <?php
                            include "koneksi.php";
                            $query_durasi = mysqli_query($koneksi,"SELECT*FROM min_dur");
                            while($res_durasi = mysqli_fetch_array($query_durasi)) {
                            ?>

                            <tr>
                                <td><?php echo $res_durasi['years']; ?></td>
                                <td><?php echo $res_durasi['min_durasi']; ?></td>
                            </tr>
                            <?php
                            };
                            ?>
                            <tr>
                                <form action="proses_tambah_durasi.php" method="POST">
                                <td width="50%"><input type="number" name="years" placeholder="Tahun"> <input type="number" name="min_durasi" placeholder="Min Durasi"></td> 
